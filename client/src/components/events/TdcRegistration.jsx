  ...
  const handleChange = (e) => {
    ...
    if (name === "dob") {
      ...
      if (formData.category === "Grassroots") {
        days = value === "swimming" ? "Monday - Friday" : "Tuesday & Thursday";
      } else if (
                ...
                <Form.Group as={Col} controlId="formGridTime" className="mb-3">
                  ...
                  >
                    ...
                    {formData.category === "Grassroots" ? (
                      ...
                      formData.category === "Senior" ? (
                        <>
                          <option value="  Sun: 8:00–9:00 AM | Mon/Wed/Fri: 3:00–4:00 PM">
                            Sun: 8:00–9:00 AM | Mon/Wed/Fri: 3:00–4:00 PM
                          </option>
                          <option value=" Sun: 9:00–10:00 PM | Mon/Wed/Fri: 4:00–5:00 PM">
                            Sun: 9:00–10:00 PM | Mon/Wed/Fri: 4:00–5:00 PM
                          </option>
                        </>
                      ) : (
                        <>
                          <option value=" Sun: 9:00–10:00 AM | Mon/Wed/Fri: 4:00–5:00 PM">
                            Sun: 9:00–10:00 AM | Mon/Wed/Fri: 4:00–5:00 PM
                          </option>
                          <option value="  Sun: 10:00–11:00 AM | Mon/Wed/Fri: 5:00–6:00 PM">
                            Sun: 10:00–11:00 AM | Mon/Wed/Fri: 5:00–6:00 PM
                          </option>
                        </>
                      )
                    ) : formData.sports === "swimming" ? (
